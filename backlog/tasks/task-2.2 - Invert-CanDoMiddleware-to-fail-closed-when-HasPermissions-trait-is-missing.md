...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Middleware aborts 403 when user model lacks HasPermissions trait
- [ ] #2 Test: authenticated user without trait gets 403 on can_do route
- [ ] #3 Test: authenticated user with trait still works as before
